...
cartItemsRouter.delete('/:id', checkJwt, database.deleteProductByProductId);

// DELETE request for deleting all cart items belonging to a single user
cartItemsRouter.delete('/delete_cart/:email', checkJwt, database.deleteAllFromCart);

// PUT request to update quantity of product by user email product id
cartItemsRouter.put('/', checkJwt, database.removeStockAddQuantity);

// PUT request to update quantity of product by user email product id
cartItemsRouter.put('/remove_quantity', checkJwt, database.removeQuantityAddStock);
